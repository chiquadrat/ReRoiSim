...
from simulation_immo_kapitalanlage import renditerechner
from text import text_generator, text_static
from figures import figure_ein_aus_gabeparameter, figure_etf_vergleich
...
#
# Callback Statische Anfangsberechnung
#
...
#
# Callback Simulation und grafische Darstellung
#
@app.callback(
