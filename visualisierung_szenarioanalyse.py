...
def berechnung_formeln (mietsteigerung, kostensteigerung):
...
#Szenario Mietsteigerung
mietsteigerung_array = np.linspace(-0.05,0.05,100)
ek_rendite_mietsteigerung = []
for i in range (len(mietsteigerung_array)):
    ek_rendite_mietsteigerung.append(berechnung_formeln(mietsteigerung_array[i],kostensteigerung))
ek_rendite_mietsteigerung_array = np.array(ek_rendite_mietsteigerung)
fig, Plot_Mietsteigerung = plt.subplots()
Plot_Mietsteigerung.plot(mietsteigerung_array*100,ek_rendite_mietsteigerung_array*100)
Plot_Mietsteigerung.set(xlabel='Mietsteigerung / %', ylabel='Eigenkapitalrendite / %')
Plot_Mietsteigerung.grid()

#Szenario Mietsteigerung
kostensteigerung_array = np.linspace(0,0.1,100)
ek_rendite_kostensteigerung = []
for i in range (len(kostensteigerung_array)):
    ek_rendite_kostensteigerung.append(berechnung_formeln(mietsteigerung, kostensteigerung_array[i]))
ek_rendite_kostensteigerung_array = np.array(ek_rendite_kostensteigerung)
fig, Plot_Kostensteigerung = plt.subplots()
Plot_Kostensteigerung.plot(kostensteigerung_array*100,ek_rendite_kostensteigerung_array*100)
Plot_Kostensteigerung.set(xlabel='Kostensteigerung / %', ylabel='Eigenkapitalrendite / %')
Plot_Kostensteigerung.grid()
